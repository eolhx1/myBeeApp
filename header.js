...
function laddaHeader(titelTekst, breadcrumbHTML = '', infoRubrik = '', infoTextHtml = '') {
    ...
    <!-- Info-modal (Skapas automatiskt om infoRubrik skickas med) -->
    ${infoRubrik ? `
...
// Globala funktioner för info-modalen
